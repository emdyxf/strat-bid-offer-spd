#ifndef _BidOfferSpread_H_
#define _BidOfferSpread_H_
...
class BidOfferSpread : public StrategyBase
{
public:

	BidOfferSpread();
	virtual ~BidOfferSpread();
	...
	int		HandleManualOrderUponCommand(long nStratId, const char* szSymbol, double dPrice, int nOrdQty, const char* szSide, int nLegId, const char* szInstr);

	double	GetStratQuotePrice (double dBenchmark, MTICK& mtick_quote, MTICK& mtick_hedge, bool bBidSpread);
	double	GetStratHedgePrice (StratParams* pStratParams, double dDriverLastPrice, bool bBidHedge);
	...
	int		UpdateStratQuoteCxlRplCount(STREET_ORDER& StreetOrder, CLIENT_ORDER& ParentOrder);
	...
	int		PublishStratLoss(StratParams* pStratParams,  MTICK& mtick_quote, MTICK& mtick_hedge, double dUnitPrice, double dNetLossQuote, double dNetLossHedge, CLIENT_ORDER& BidQuoteOrder, CLIENT_ORDER& BidHedgeOrder, CLIENT_ORDER& OfferQuoteOrder, CLIENT_ORDER& OfferHedgeOrder);
